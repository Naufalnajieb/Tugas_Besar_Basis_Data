...
<html>
  ...
  <body id="LoginForm">
    ...
    <div class="admin">
      <a href="login.php" class="btn btn-primary">User Page</a>
    </div>
    ...
    <div class="login-form">
        <div class="main-div">
            ...
            <form id="Login" method="POST" action="loginfuncadmin.php">
                <div class="form-group">
                    <input type="text" value="<?php if (isset($_COOKIE["user"])){echo $_COOKIE["user"];}?>" name="email" class="form-control" id="inputEmail" placeholder="Email Address">
                </div>
                <div class="form-group">
                ...
                <div class="register">
                    <a href="regPegawai.php">Register Here!</a>
                </div>
                <div class="forgot">
