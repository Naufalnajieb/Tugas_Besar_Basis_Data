...
if (isset($_POST["submit"])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $stmt = $conn->prepare("INSERT INTO pegawai (nama_pegawai, kontak_pegawai, email, password) VALUES (?, ?, ?, ?)");
    ...
    <div class="main-div">
        ...
        <form action="#" method="post" role="form" id="form-add" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_pegawai" name="nama_pegawai" required value"">
            </div>
            <div class="mb-3">
                <label for="kontak_pegawai" class="form-label">No Telp</label>
                <input type="text" class="form-control" id="kontak_pegawai" name="kontak_pegawai" required value"">
            </div>
            <div class="mb-3">
