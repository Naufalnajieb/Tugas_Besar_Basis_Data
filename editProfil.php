<?php
    ...
    $listProfil = readPelanggan();

    if(isset($_GET['id_pelanggan'])){
      $idpelanggan = $_GET['id_pelanggan'];
      $data = readQuery('pelanggan', 'id_pelanggan', $idpelanggan);
      if(!count($data)){
        echo "
        <script>
    ...
    if (isset($_POST['btn-edit-profil'])) {
        ...
        $isAddSucceed = updatePelanggan($_POST, $_FILES);
        if ($isAddSucceed > 0) {
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li><a href="editProfil.php"> Hello <?=$data['nama_pelanggan']?></a></li>
  ...
  <div class="main-div">
        ...
        <form action="#" method="post" role="form" id="form-add" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="kontak_pelanggan" name="kontak_pelanggan" value="<?= $data['kontak_pelanggan'] ?>" required>
            </div>
            <div class="mb-3">
